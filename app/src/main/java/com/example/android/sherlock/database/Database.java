...
public class Database extends SQLiteOpenHelper {
    ...
    public void addTestData() {
        ...
        Item west24 = new Item(WEST24, "Standard definition 24 Inch television", 89.99, tarId, WEST24_URL);
        Item west242 = new Item(WEST24, "Standard definition television", 119.99, costcoId, WEST24_URL);
        Item west243 = new Item(WEST24, "Brand new television", 85.99, bbId, WEST24_URL);
        addItem(west24);
        addItem(west242);
        addItem(west243);
        final String VIZIO24D = "Vizio 24 Inch 720p LED Television";
        final String VIZIO24D_URL = "https://i.imgur.com/n1XVKT9.jpg";
        Item vizio24d = new Item(VIZIO24D, "Standard definition 24 Inch television", 89.99, tarId, VIZIO24D_URL);
        Item vizio24d2 = new Item(VIZIO24D, "Standard definition television", 119.99, costcoId, VIZIO24D_URL);
        Item vizio24d3 = new Item(VIZIO24D, "Brand new television", 85.99, bbId, VIZIO24D_URL);
        addItem(vizio24d);
        addItem(vizio24d2);
        addItem(vizio24d3);
        ...
        Item lg24lf2 = new Item(LG24LF, "Standard definition television", 119.99, costcoId, LG24LF_URL);
        Item lg24lf3 = new Item(LG24LF, "Brand new television", 89.99, bbId, LG24LF_URL);
        addItem(lg24lf);
        addItem(lg24lf2);
        addItem(lg24lf3);
        ...
        Item west32sm2 = new Item(WEST32SM, "Standard definition smart television", 119.99, costcoId, WEST32SM_URL);
        Item west32sm3 = new Item(WEST32SM, "Brand new smart television", 119.99, bbId, WEST32SM_URL);
        addItem(west32sm);
        addItem(west32sm2);
        addItem(west32sm3);
        ...
        Item west32smh = new Item(WEST32SM, "Standard definition 32 Inch television", 139.99, tarId, WEST32SM_URL);
        Item west32smh2 = new Item(WEST32SM, "Standard definition smart television", 129.99, costcoId, WEST32SM_URL);
        Item west32smh3 = new Item(WEST32SM, "Brand new smart television", 119.99, bbId, WEST32SM_URL);
        addItem(west32smh);
        addItem(west32smh2);
        addItem(west32smh3);
        ...
        Item sam242 = new Item(SAM24, "Standard definition television", 135.99, costcoId, SAM24_URL);
        Item sam243 = new Item(SAM24, "Brand new television", 125.99, bbId, SAM24_URL);
        addItem(sam24);
        addItem(sam242);
        addItem(sam243);
        ...
        Item viz24f3 = new Item(VIZ24F, "Brand new television", 139.99, bbId, VIZ24F_URL);
        addItem(viz24f);
        addItem(viz24f2);
        addItem(viz24f3);
        ...
        Item sams282 = new Item(SAMS28, "Standard definition television", 185.99, costcoId, SAMS28_URL);
        Item sams283 = new Item(SAMS28, "Brand new television", 189.99, bbId, SAMS28_URL);
        addItem(sams28);
        addItem(sams282);
        addItem(sams283);
        ...
        Item lg282 = new Item(LG28, "Standard definition television", 185.99, costcoId, LG28_URL);
        Item lg283 = new Item(LG28, "Brand new television", 179.99, bbId, LG28_URL);
        addItem(lg28);
        addItem(lg282);
        addItem(lg283);
        ...
        Item wh322 = new Item(WH32, "Standard definition television", 165.99, costcoId, WH32_URL);
        Item wh323 = new Item(WH32, "Brand new television", 179.99, bbId, WH32_URL);
        addItem(wh32);
        addItem(wh322);
        addItem(wh323);
        ...
        Item ps322 = new Item(PS32, "Standard definition television", 165.99, costcoId, PS32_URL);
        Item ps323 = new Item(PS32, "Brand new television", 189.99, bbId, PS32_URL);
        addItem(ps32);
        addItem(ps322);
        addItem(ps323);
        ...
        Item ps242 = new Item(PS24, "Standard definition television", 175.99, costcoId, PS24_URL);
        Item ps243 = new Item(PS24, "Brand new television", 189.99, bbId, PS24_URL);
        addItem(ps24);
        addItem(ps242);
        addItem(ps243);
        ...
        Item lg32m2 = new Item(LG32M, "Standard definition television", 175.99, costcoId, LG32M_URL);
        Item lg32m3 = new Item(LG32M, "Brand new television", 219.99, bbId, LG32M_URL);
        addItem(lg32m);
        addItem(lg32m2);
        addItem(lg32m3);
        ...
        Item ss32j2 = new Item(SS32J, "Standard definition television", 175.99, costcoId, SS32J_URL);
        Item ss32j3 = new Item(SS32J, "Brand new television", 189.99, bbId, SS32J_URL);
        addItem(ss32j);
        addItem(ss32j2);
        addItem(ss32j3);
        ...
        Item ss5860703 = new Item(SS586070, "Brand new television", 750.99, bbId, SS586070_URL);
        addItem(ss586070);
        addItem(ss5860702);
        addItem(ss5860703);
        ...
        Item ss5560702 = new Item(SS556070, "Ultra High definition television", 695.99, costcoId, SS556070_URL);
        Item ss5560703 = new Item(SS556070, "Brand new television", 750.99, bbId, SS556070_URL);
        addItem(ss556070);
        addItem(ss5560702);
        addItem(ss5560703);
        ...
        Item ss556073 = new Item(SS55607, "Brand new television", 750.99, bbId, SS55607_URL);
        addItem(ss55607);
        addItem(ss556072);
        addItem(ss556073);
        ...
        Item ss4970003 = new Item(SS497000, "Brand new television", 745.99, bbId, SS497000_URL);
        addItem(ss497000);
        addItem(ss4970002);
        addItem(ss4970003);
