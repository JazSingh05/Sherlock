...
public class Database extends SQLiteOpenHelper {
    ...
    public void addTestData() {
        ...
        final String GTA5 = "Grand Theft Auto 5";
        final String GTA5_URL = "https://i.imgur.com/GkaTQPS.jpg";
        final String GTA5_DES = "Girls, guns, gangs, and explosions game";
        Item gta5 = new Item(GTA5, GTA5_DES , 59.99, tarId, GTA5_URL);
        Item gta52 = new Item(GTA5, GTA5_DES , 59.99, costcoId, GTA5_URL);
        Item gta53 = new Item(GTA5, GTA5_DES, 59.99, bbId, GTA5_URL);
        addItem(gta5);
        addItem(gta52);
        addItem(gta53);
        final String COD = "Call of Duty WWII";
        final String COD_URL = "https://i.imgur.com/fsbjHsm.jpg";
        final String COD_DES = "First-Person shooter that takes place during world war II game";
        Item cod = new Item(COD, COD_DES , 49.99, tarId, COD_URL);
        Item cod2 = new Item(COD, COD_DES , 49.99, costcoId, COD_URL);
        Item cod3 = new Item(COD, COD_DES, 49.99, bbId, COD_URL);
        addItem(cod);
        addItem(cod2);
        addItem(cod3);
        final String NBA = "NBA 2K18";
        final String NBA_URL = "https://i.imgur.com/VogdwUw.jpg";
        final String NBA_DES = "NBA basketball game";
        Item nba = new Item(NBA, NBA_DES , 39.99, tarId, NBA_URL);
        Item nba2 = new Item(NBA, NBA_DES , 39.99, costcoId, NBA_URL);
        Item nba3 = new Item(NBA, NBA_DES, 39.99, bbId, NBA_URL);
        addItem(nba);
        addItem(nba2);
        addItem(nba3);
        final String PUBG = "PLAYERUNKNOWN'S BATTLEGROUNDS";
        final String PUBG_URL = "https://i.imgur.com/G4585HG.jpg";
        final String PUBG_DES = "A free for all battle royale game";
        Item pubg = new Item(PUBG, PUBG_DES , 29.99, tarId, PUBG_URL);
        Item pubg2 = new Item(PUBG, PUBG_DES , 29.99, costcoId, PUBG_URL);
        Item pubg3 = new Item(PUBG, PUBG_DES, 29.99, bbId, PUBG_URL);
        addItem(pubg);
        addItem(pubg2);
        addItem(pubg3);
        final String MHW = "Monster Hunter: World";
        final String MHW_URL = "https://i.imgur.com/zlFE67o.jpg";
        final String MHW_DES = "a game about hunting monsters";
        Item mhw = new Item(MHW, MHW_DES , 59.99, tarId, MHW_URL);
        Item mhw2 = new Item(MHW, MHW_DES , 59.99, costcoId, MHW_URL);
        Item mhw3 = new Item(MHW, MHW_DES, 59.99, bbId, MHW_URL);
        addItem(mhw);
        addItem(mhw2);
        addItem(mhw3);
        final String WIT = "The Witcher: Wild Hunt";
        final String WIT_URL = "https://i.imgur.com/FdIAWeW.jpg";
        final String WIT_DES = "a mercenary that kills monsters game";
        Item wit = new Item(WIT, WIT_DES , 19.99, tarId, WIT_URL);
        Item wit2 = new Item(WIT, WIT_DES , 19.99, costcoId, WIT_URL);
        Item wit3 = new Item(WIT, WIT_DES, 19.99, bbId, WIT_URL);
        addItem(wit);
        addItem(wit2);
        addItem(wit3);
        final String ACO= "Assassin's Creed Origins";
        final String ACO_URL = "https://i.imgur.com/0mWnsIb.jpg";
        final String ACO_DES = "a game where you are an assassin";
        Item aco = new Item(ACO, ACO_DES , 59.99, tarId, ACO_URL);
        Item aco2 = new Item(ACO, ACO_DES , 59.99, costcoId, ACO_URL);
        Item aco3 = new Item(ACO, ACO_DES, 59.99, bbId, ACO_URL);
        addItem(aco);
        addItem(aco2);
        addItem(aco3);
        final String MC = "Minecraft: Xbox One Edition";
        final String MC_URL = "https://i.imgur.com/NBt0Flv.jpg";
        final String MC_DES = "a game where you mine and build";
        Item mc = new Item(MC, MC_DES , 19.99, tarId, MC_URL);
        Item mc2 = new Item(MC, MC_DES , 19.99, costcoId, MC_URL);
        Item mc3 = new Item(MC, MC_DES, 19.99, bbId, MC_URL);
        addItem(mc);
        addItem(mc2);
        addItem(mc3);
        final String FIFA = "EA Sports FIFA 18";
        final String FIFA_URL = "https://i.imgur.com/o29gzAW.jpg";
        final String FIFA_DES = "a game where you play soccer";
        Item fifa = new Item(FIFA, FIFA_DES , 59.99, tarId, FIFA_URL);
        Item fifa2 = new Item(FIFA, FIFA_DES , 59.99, costcoId, FIFA_URL);
        Item fifa3 = new Item(FIFA, FIFA_DES, 59.99, bbId, FIFA_URL);
        addItem(fifa);
        addItem(fifa2);
        addItem(fifa3);
        final String FORZ = "Forza Motorsport 7";
        final String FORZ_URL = "https://i.imgur.com/k1kbfWv.jpg";
        final String FORZ_DES = "a game where you race cars";
        Item forz = new Item(FORZ, FORZ_DES , 59.99, tarId, FORZ_URL);
        Item forz2 = new Item(FORZ, FORZ_DES , 59.99, costcoId, FORZ_URL);
        Item forz3 = new Item(FORZ, FORZ_DES, 59.99, bbId, FORZ_URL);
        addItem(forz);
        addItem(forz2);
        addItem(forz3);
        final String HALO = "Halo 5: Guardians";
        final String HALO_URL = "https://i.imgur.com/N8WZyaH.jpg";
        final String HALO_DES = "a game where you are master chief";
        Item halo = new Item(HALO, HALO_DES , 19.99, tarId, HALO_URL);
        Item halo2 = new Item(HALO, HALO_DES , 19.99, costcoId, HALO_URL);
        Item halo3 = new Item(HALO, HALO_DES, 19.99, bbId, HALO_URL);
        addItem(halo);
        addItem(halo2);
        addItem(halo3);
        final String DBZ = "Dragon Ball FighterZ";
        final String DBZ_URL = "https://i.imgur.com/HDnZKt8.jpg";
        final String DBZ_DES = "a game where you play as goku";
        Item dbz = new Item(DBZ, DBZ_DES , 59.99, tarId, DBZ_URL);
        Item dbz2 = new Item(DBZ, DBZ_DES , 59.99, costcoId, DBZ_URL);
        Item dbz3 = new Item(DBZ, DBZ_DES, 59.99, bbId, DBZ_URL);
        addItem(dbz);
        addItem(dbz2);
        addItem(dbz3);
        final String RAIN = "Tom Clancy's Rainbow Six Siege";
        final String RAIN_URL = "https://i.imgur.com/S748K1S.jpg";
        final String RAIN_DES = "a game where you breach a house";
        Item rain = new Item(RAIN, RAIN_DES , 59.99, tarId, RAIN_URL);
        Item rain2 = new Item(RAIN, RAIN_DES , 59.99, costcoId, RAIN_URL);
        Item rain3 = new Item(RAIN, RAIN_DES, 59.99, bbId, RAIN_URL);
        addItem(rain);
        addItem(rain2);
        addItem(rain3);
        final String SWBF = "Star Wars Battlefront II";
        final String SWBF_URL = "https://i.imgur.com/3iESxRu.jpg";
        final String SWBF_DES = "a game where you are a clone trooper";
        Item swbf = new Item(SWBF, SWBF_DES , 59.99, tarId, SWBF_URL);
        Item swbf2 = new Item(SWBF, SWBF_DES , 59.99, costcoId, SWBF_URL);
        Item swbf3 = new Item(SWBF, SWBF_DES, 59.99, bbId, SWBF_URL);
        addItem(swbf);
        addItem(swbf2);
        addItem(swbf3);
        final String PVZ = "Plants vs Zombies: Garden Warfare 2";
        final String PVZ_URL = "https://i.imgur.com/iQvXWYR.jpg";
        final String PVZ_DES = "a game where you use plants to fight zombies";
        Item pvz = new Item(PVZ, PVZ_DES , 19.99, tarId, PVZ_URL);
        Item pvz2 = new Item(PVZ, PVZ_DES , 19.99, costcoId, PVZ_URL);
        Item pvz3 = new Item(PVZ, PVZ_DES, 19.99, bbId, PVZ_URL);
        addItem(pvz);
        addItem(pvz2);
        addItem(pvz3);
        final String MKX = "Mortal Kombat X";
        final String MKX_URL = "https://i.imgur.com/88X618H.jpg";
        final String MKX_DES = "a game where you fight each other to fatality";
        Item mkx = new Item(MKX, MKX_DES , 19.99, tarId, MKX_URL);
        Item mkx2 = new Item(MKX, MKX_DES , 19.99, costcoId, MKX_URL);
        Item mkx3 = new Item(MKX, MKX_DES, 19.99, bbId, MKX_URL);
        addItem(mkx);
        addItem(mkx2);
        addItem(mkx3);
        ...
        Item des3 = new Item(DES, DES_DES, 49.99, bbId, DES_URL);
        addItem(des);
        addItem(des2);
        addItem(des3);
        final String BF1 = "Battlefield 1";
        final String BF1_URL = "https://i.imgur.com/axETz9N.jpg";
        final String BF1_DES = "a game where you are in a full on war multiplayer";
        Item bf1 = new Item(BF1, BF1_DES , 19.99, tarId, BF1_URL);
        Item bf12 = new Item(BF1, BF1_DES , 19.99, costcoId, BF1_URL);
        Item bf13 = new Item(BF1, BF1_DES, 19.99, bbId, BF1_URL);
        addItem(bf1);
        addItem(bf12);
        addItem(bf13);
        final String FORT = "Fortnite";
        final String FORT_URL = "https://i.imgur.com/g6eQuU6.jpg";
        final String FORT_DES = "a game where you are in a battle royale and can build";
        Item fort = new Item(FORT, FORT_DES , 59.99, tarId, FORT_URL);
        Item fort2 = new Item(FORT, FORT_DES , 59.99, costcoId, FORT_URL);
        Item fort3 = new Item(FORT, FORT_DES, 59.99, bbId, FORT_URL);
        addItem(fort);
        addItem(fort2);
        addItem(fort3);
        final String BOTW = "The Legend of Zelda: Breath of the Wild";
        final String BOTW_URL = "https://i.imgur.com/9X7bV06.jpg";
        final String BOTW_DES = "a game where you are link in zelda";
        Item botw = new Item(BOTW, BOTW_DES , 49.99, tarId, BOTW_URL);
        Item botw2 = new Item(BOTW, BOTW_DES , 49.99, costcoId, BOTW_URL);
        Item botw3 = new Item(BOTW, BOTW_DES, 44.99, bbId, BOTW_URL);
        addItem(botw);
        addItem(botw2);
        addItem(botw3);
        final String SMO = "Super Mario Odyssey";
        final String SMO_URL = "https://i.imgur.com/7Hr1lCW.jpg";
        final String SMO_DES = "a game where you are mario and fling your hat";
        Item smo = new Item(SMO, SMO_DES , 49.99, tarId, SMO_URL);
        Item smo2 = new Item(SMO, SMO_DES , 49.99, costcoId, SMO_URL);
        Item smo3 = new Item(SMO, SMO_DES, 48.99, bbId, SMO_URL);
        addItem(smo);
        addItem(smo2);
        addItem(smo3);
        ...
        Item kart3 = new Item(KART, KART_DES, 59.99, bbId, KART_URL);
        addItem(kart);
        addItem(kart2);
        addItem(kart3);
        ...
        Item spla3 = new Item(SPLA, SPLA_DES, 59.99, bbId, SPLA_URL);
        addItem(spla);
        addItem(spla2);
        addItem(spla3);
        final String KIRBY = "Kirby Star Allies";
        final String KIRBY_URL = "https://i.imgur.com/i7vSExW.jpg";
        final String KIRBY_DES = "a game where you are kirby and his allies";
        Item kirby = new Item(KIRBY, KIRBY_DES , 59.99, tarId, KIRBY_URL);
        Item kirby2 = new Item(KIRBY, KIRBY_DES , 59.99, costcoId, KIRBY_URL);
        Item kirby3 = new Item(KIRBY, KIRBY_DES, 59.99, bbId, KIRBY_URL);
        addItem(kirby);
        addItem(kirby2);
        addItem(kirby3);
        final String XENO = "Xenoblade Chronicles 2";
        final String XENO_URL = "https://i.imgur.com/iKo3TVT.jpg";
        final String XENO_DES = "a game where you have a dope sword";
        Item xeno = new Item(XENO, XENO_DES , 59.99, tarId, XENO_URL);
        Item xeno2 = new Item(XENO, XENO_DES , 59.99, costcoId, XENO_URL);
        Item xeno3 = new Item(XENO, XENO_DES, 59.99, bbId, XENO_URL);
        addItem(xeno);
        addItem(xeno2);
        addItem(xeno3);
