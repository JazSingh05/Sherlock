...
public class Database extends SQLiteOpenHelper {
    ...
    public void addTestData() {
        ...
        Item beets = new Item(BEETS, BEETS_DESC, 1.99, vonsId, BEER_URL);
        Item beets1 = new Item(BEETS, BEETS_DESC, 1.99, ralphsId, BEER_URL);
        Item beets2 = new Item(BEETS, BEETS_DESC, 1.99, sfId, BEER_URL);
        Item beets3 = new Item(BEETS, BEETS_DESC, 1.99, slomId, BEER_URL);
        Item beets4 = new Item(BEETS, BEETS_DESC, 1.99, f4lId, BEER_URL);
        Item beets5 = new Item(BEETS, BEETS_DESC, 1.99, tjsId, BEER_URL);
        Item beets6 = new Item(BEETS, BEETS_DESC, 1.99, wfId, BEER_URL);
        addItem(beets);
        addItem(beets1);
        addItem(beets2);
        addItem(beets3);
