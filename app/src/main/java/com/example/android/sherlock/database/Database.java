...
public class Database extends SQLiteOpenHelper {
    ...
    public void addTestData() {
        ...
        addItem(carrot2);
        addItem(carrot3);
        final String GARLIC_POWDER = "Garlic Powder";
        final String GARLIC_POWDER_URL = "https://i.imgur.com/aSm1hCE.jpg";
        final String GARLIC_POWDER_DESC =  "Finely ground garlic";
        Item garlicPowder = new Item(GARLIC_POWDER, GARLIC_POWDER_DESC,  1.79, vonsId, GARLIC_POWDER_URL);
        Item garlicPowder1 = new Item(GARLIC_POWDER, GARLIC_POWDER_DESC,  1.97, ralphsId, GARLIC_POWDER_URL);
        Item garlicPowder2 = new Item(GARLIC_POWDER, GARLIC_POWDER_DESC,  1.81, sfId, GARLIC_POWDER_URL);
        addItem(garlicPowder);
        addItem(garlicPowder1);
        addItem(garlicPowder2);
        final String GARLIC_SALT = "Garlic Salt";
        final String GARLIC_SALT_URL = "https://i.imgur.com/2Tq2wK7.jpg";
        final String GARLIC_SALT_DESC = "Finely ground garlic with added salt";
        Item garlicSalt = new Item(GARLIC_SALT, GARLIC_SALT_DESC, 3.99, vonsId, GARLIC_SALT_URL);
        Item garlicSalt1 = new Item(GARLIC_SALT, GARLIC_SALT_DESC, 3.89, ralphsId, GARLIC_SALT_URL);
        Item garlicSalt2 = new Item(GARLIC_SALT, GARLIC_SALT_DESC, 3.79, sfId, GARLIC_SALT_URL);
        Item garlicSalt3 = new Item(GARLIC_SALT, GARLIC_SALT_DESC, 3.79, slomId, GARLIC_SALT_URL);
        Item garlicSalt4 = new Item(GARLIC_SALT, GARLIC_SALT_DESC, 3.79, f4lId, GARLIC_SALT_URL);
        addItem(garlicSalt);
        addItem(garlicSalt1);
        addItem(garlicSalt2);
        addItem(garlicSalt3);
        addItem(garlicSalt4);
        final String CUMIN = "Cumin";
        final String CUMIN_URL = "https://i.imgur.com/N6BBqVn.jpg";
        final String CUMIN_DESC = "Ground seeds, similar in flavor to parsley";
        Item cumin = new Item(CUMIN, CUMIN_DESC, .98, vonsId, CUMIN_URL);
        Item cumin1 = new Item(CUMIN, CUMIN_DESC, .99, ralphsId, CUMIN_URL);
        Item cumin2 = new Item(CUMIN, CUMIN_DESC, .99, sfId, CUMIN_URL);
        Item cumin3 = new Item(CUMIN, CUMIN_DESC, 1.10, slomId, CUMIN_URL);
        Item cumin4 = new Item(CUMIN, CUMIN_DESC, 1.25, f4lId, CUMIN_URL);
        addItem(cumin);
        addItem(cumin1);
        addItem(cumin2);
        addItem(cumin3);
        addItem(cumin4);
        final String PARSLEY = "Parsley";
        final String PARSLEY_URL = "https://i.imgur.com/t9nJNr0.jpg";
        final String PARSLEY_DESC = "Garden plant and highly used herb";
        Item parsley = new Item(PARSLEY, PARSLEY_DESC, 1.89, vonsId, PARSLEY_URL);
        Item parsley1 = new Item(PARSLEY, PARSLEY_DESC, 1.89, ralphsId, PARSLEY_URL);
        Item parsley2 = new Item(PARSLEY, PARSLEY_DESC, 1.89, sfId, PARSLEY_URL);
        Item parsley3 = new Item(PARSLEY, PARSLEY_DESC, 1.89, slomId, PARSLEY_URL);
        Item parsley4 = new Item(PARSLEY, PARSLEY_DESC, 1.89, f4lId, PARSLEY_URL);
        addItem(parsley);
        addItem(parsley1);
        addItem(parsley2);
        addItem(parsley3);
        addItem(parsley4);
        final String OREGANO = "Oregano";
        final String OREGANO_URL = "https://i.imgur.com/lHmoAWK.jpg";
        final String OREGANO_DESC = "One of the most popular herbs,";
        Item oregano = new Item(OREGANO, OREGANO_DESC, 2.79, vonsId, OREGANO_URL);
        Item oregano1 = new Item(OREGANO, OREGANO_DESC, 2.79, ralphsId, OREGANO_URL);
        Item oregano2 = new Item(OREGANO, OREGANO_DESC, 2.79, sfId, OREGANO_URL);
        Item oregano3 = new Item(OREGANO, OREGANO_DESC, 2.79, slomId, OREGANO_URL);
        Item oregano4 = new Item(OREGANO, OREGANO_DESC, 2.79, f4lId, OREGANO_URL);
        addItem(oregano);
        addItem(oregano1);
        addItem(oregano2);
        addItem(oregano3);
        addItem(oregano4);
        final String ALLSPICE = "Allspice";
        final String ALLSPICE_URL = "https://i.imgur.com/Qkb8wXu.jpg";
        final String ALLSPICE_DESC = "Mix of many popular herbs and spices";
        Item allspice = new Item(ALLSPICE, ALLSPICE_DESC, 2.99, vonsId, ALLSPICE_URL);
        Item allspice1 = new Item(ALLSPICE, ALLSPICE_DESC, 2.89, ralphsId, ALLSPICE_URL);
        Item allspice2 = new Item(ALLSPICE, ALLSPICE_DESC, 2.79, sfId, ALLSPICE_URL);
        Item allspice3 = new Item(ALLSPICE, ALLSPICE_DESC, 2.69, slomId, ALLSPICE_URL);
        Item allspice4 = new Item(ALLSPICE, ALLSPICE_DESC, 2.59, f4lId, ALLSPICE_URL);
        addItem(allspice);
        addItem(allspice1);
        addItem(allspice2);
        addItem(allspice3);
        addItem(allspice4);
        final String CHILI_POWDER = "Chili Powder";
        final String CHILI_POWDER_URL = "https://i.imgur.com/MXH2wz4.jpg";
        final String CHILI_POWDER_DESC = "Ground chili, tasty with a kick";
        Item chiliPowder = new Item(CHILI_POWDER, CHILI_POWDER_DESC, 2.89, vonsId, CHILI_POWDER_URL);
        Item chiliPowder1 = new Item(CHILI_POWDER, CHILI_POWDER_DESC, 2.89, ralphsId, CHILI_POWDER_URL);
        Item chiliPowder2 = new Item(CHILI_POWDER, CHILI_POWDER_DESC, 2.89, sfId, CHILI_POWDER_URL);
        Item chiliPowder3 = new Item(CHILI_POWDER, CHILI_POWDER_DESC, 2.89, slomId, CHILI_POWDER_URL);
        Item chiliPowder4 = new Item(CHILI_POWDER, CHILI_POWDER_DESC, 2.89, f4lId, CHILI_POWDER_URL);
        addItem(chiliPowder);
        addItem(chiliPowder1);
        addItem(chiliPowder2);
        addItem(chiliPowder3);
        addItem(chiliPowder4);
        final String BAY_LEAVES = "Bay Leaves";
        final String BAY_LEAVES_URL = "https://i.imgur.com/SveAUfr.jpg";
        final String BAY_LEAVES_DESC = "A vegan dinner";
        Item bayLeaves = new Item(BAY_LEAVES, BAY_LEAVES_DESC, 4.59, vonsId, BAY_LEAVES_URL);
        Item bayLeaves1 = new Item(BAY_LEAVES, BAY_LEAVES_DESC, 4.59, ralphsId, BAY_LEAVES_URL);
        Item bayLeaves2 = new Item(BAY_LEAVES, BAY_LEAVES_DESC, 4.59, sfId, BAY_LEAVES_URL);
        Item bayLeaves3 = new Item(BAY_LEAVES, BAY_LEAVES_DESC, 4.59, slomId, BAY_LEAVES_URL);
        Item bayLeaves4 = new Item(BAY_LEAVES, BAY_LEAVES_DESC, 4.59, f4lId, BAY_LEAVES_URL);
        addItem(bayLeaves);
        addItem(bayLeaves1);
        addItem(bayLeaves2);
        addItem(bayLeaves3);
        addItem(bayLeaves4);
        final String CURRY_LEAVES = "Curry Leaves";
        final String CURRY_LEAVES_URL = "https://i.imgur.com/QdU7rqD.jpg";
        final String CURRY_LEAVES_DESC = "";
        Item curryLeaves = new Item(CURRY_LEAVES, CURRY_LEAVES_DESC, 3.99, vonsId, CURRY_LEAVES_URL);
        Item curryLeaves1 = new Item(CURRY_LEAVES, CURRY_LEAVES_DESC, 3.99, ralphsId, CURRY_LEAVES_URL);
        Item curryLeaves2 = new Item(CURRY_LEAVES, CURRY_LEAVES_DESC, 3.99, sfId, CURRY_LEAVES_URL);
        Item curryLeaves3 = new Item(CURRY_LEAVES, CURRY_LEAVES_DESC, 3.99, slomId, CURRY_LEAVES_URL);
        Item curryLeaves4 = new Item(CURRY_LEAVES, CURRY_LEAVES_DESC, 3.99, f4lId, CURRY_LEAVES_URL);
        addItem(curryLeaves);
        addItem(curryLeaves1);
        addItem(curryLeaves2);
        addItem(curryLeaves3);
        addItem(curryLeaves4);
        final String CABBAGE = "Cabbage";
        final String CABBAGE_URL = "https://i.imgur.com/k1Sovcr.jpg";
        final String CABBAGE_DESC = "Green vegetable, similar to lettuce";
        Item cabbage = new Item(CABBAGE, CABBAGE_DESC, 1.99, vonsId, CABBAGE_URL);
        Item cabbage1 = new Item(CABBAGE, CABBAGE_DESC, 1.89, ralphsId, CABBAGE_URL);
        Item cabbage2 = new Item(CABBAGE, CABBAGE_DESC, 1.79, sfId, CABBAGE_URL);
        Item cabbage3 = new Item(CABBAGE, CABBAGE_DESC, 1.69, slomId, CABBAGE_URL);
        Item cabbage4 = new Item(CABBAGE, CABBAGE_DESC, 1.59, f4lId, CABBAGE_URL);
        addItem(cabbage);
        addItem(cabbage1);
        addItem(cabbage2);
        addItem(cabbage3);
        addItem(cabbage4);
        final String PARSNIP = "Parsnip";
        final String PARSNIP_URL = "https://i.imgur.com/RWCAZHX.jpg";
        final String PARSNIP_DESC = "Root vegetable that is dense with vitamins. Similar to carrots";
        Item parsnip = new Item(PARSNIP, PARSNIP_DESC, 1.99, vonsId, PARSNIP_URL);
        Item parsnip1 = new Item(PARSNIP, PARSNIP_DESC, 1.99, ralphsId, PARSNIP_URL);
        Item parsnip2 = new Item(PARSNIP, PARSNIP_DESC, 1.99, sfId, PARSNIP_URL);
        Item parsnip3 = new Item(PARSNIP, PARSNIP_DESC, 1.99, slomId, PARSNIP_URL);
        Item parsnip4 = new Item(PARSNIP, PARSNIP_DESC, 1.99, f4lId, PARSNIP_URL);
        addItem(parsnip);
        addItem(parsnip1);
        addItem(parsnip2);
        addItem(parsnip3);
        ...
        final String PEACH_URL = "https://i.imgur.com/v4yM4O6.jpg";
        final String PEACH_DESC = "Soft and sweet fruit";
        Item peach = new Item(PEACH, PEACH_DESC, .98, vonsId, PEACH_URL);
        Item peach1 = new Item(PEACH, PEACH_DESC, .98, ralphsId, PEACH_URL);
        Item peach2 = new Item(PEACH, PEACH_DESC, .98, sfId, PEACH_URL);
        Item peach3 = new Item(PEACH, PEACH_DESC, .98, slomId, PEACH_URL);
        Item peach4 = new Item(PEACH, PEACH_DESC, .98, f4lId, PEACH_URL);
        addItem(peach);
        addItem(peach1);
        addItem(peach2);
        addItem(peach3);
        addItem(peach4);
        final String SCALLIONS = "Scallions";
        final String SCALLIONS_URL = "https://i.imgur.com/vFPy4Re.jpg";
        final String SCALLIONS_DESC = "Commonly known as green onions";
        Item scallions = new Item(SCALLIONS, SCALLIONS_DESC, .98, vonsId, SCALLIONS_URL);
        Item scallions1 = new Item(SCALLIONS, SCALLIONS_DESC, .98, ralphsId, SCALLIONS_URL);
        Item scallions2 = new Item(SCALLIONS, SCALLIONS_DESC, .98, sfId, SCALLIONS_URL);
        Item scallions3 = new Item(SCALLIONS, SCALLIONS_DESC, .98, slomId, SCALLIONS_URL);
        Item scallions4 = new Item(SCALLIONS, SCALLIONS_DESC, .98, f4lId, SCALLIONS_URL);
        Item scallions5 = new Item(SCALLIONS, SCALLIONS_DESC, .98, tjsId, SCALLIONS_URL);
        Item scallions6 = new Item(SCALLIONS, SCALLIONS_DESC, .98, wfId, SCALLIONS_URL);
        addItem(scallions);
        addItem(scallions1);
        addItem(scallions2);
        addItem(scallions3);
        ...
        addItem(scallions5);
        addItem(scallions6);
        final String BEETS = "Beets";
        final String BEETS_URL = "https://i.imgur.com/e9a2bSr.jpg";
        final String BEETS_DESC = "Popular North American vegetable";
        Item beets = new Item(BEETS, BEETS_DESC, 1.99, vonsId, BEETS_URL);
        Item beets1 = new Item(BEETS, BEETS_DESC, 1.99, ralphsId, BEETS_URL);
        Item beets2 = new Item(BEETS, BEETS_DESC, 1.99, sfId, BEETS_URL);
        Item beets3 = new Item(BEETS, BEETS_DESC, 1.99, slomId, BEETS_URL);
        Item beets4 = new Item(BEETS, BEETS_DESC, 1.99, f4lId, BEETS_URL);
        Item beets5 = new Item(BEETS, BEETS_DESC, 1.99, tjsId, BEETS_URL);
        Item beets6 = new Item(BEETS, BEETS_DESC, 1.99, wfId, BEETS_URL);
        addItem(beets);
        addItem(beets1);
        addItem(beets2);
        addItem(beets3);
        ...
        addItem(beets5);
        addItem(beets6);
        final String CANNED_CORN = "Canned Corn";
        final String CANNED_CORN_URL = "https://i.imgur.com/xvhO2UY.jpg";
        final String CANNED_CORN_DESC = "Corn in a can";
        Item cannedCorn = new Item(CANNED_CORN, CANNED_CORN_DESC, 1.29, vonsId, CANNED_CORN_URL);
        Item cannedCorn1 = new Item(CANNED_CORN, CANNED_CORN_DESC, 1.29, ralphsId, CANNED_CORN_URL);
        Item cannedCorn2 = new Item(CANNED_CORN, CANNED_CORN_DESC, 1.29, sfId, CANNED_CORN_URL);
        Item cannedCorn3 = new Item(CANNED_CORN, CANNED_CORN_DESC, 1.29, slomId, CANNED_CORN_URL);
        Item cannedCorn4 = new Item(CANNED_CORN, CANNED_CORN_DESC, 1.29, f4lId, CANNED_CORN_URL);
        Item cannedCorn5 = new Item(CANNED_CORN, CANNED_CORN_DESC, 1.29, tjsId, CANNED_CORN_URL);
        Item cannedCorn6 = new Item(CANNED_CORN, CANNED_CORN_DESC, 1.29, wfId, CANNED_CORN_URL);
        addItem(cannedCorn);
        addItem(cannedCorn1);
        addItem(cannedCorn2);
        addItem(cannedCorn3);
        ...
        addItem(cannedCorn5);
        addItem(cannedCorn6);
        final String FROZEN_PEAS = "Frozen Peas";
        final String FROZEN_PEAS_URL = "https://i.imgur.com/yRsT43Z.jpg";
        final String FROZEN_PEAS_DESC = "Farm fresh, frozen peas";
        Item frozenPeas = new Item(FROZEN_PEAS, FROZEN_PEAS_DESC, 2.49, vonsId, FROZEN_PEAS_URL);
        Item frozenPeas1 = new Item(FROZEN_PEAS, FROZEN_PEAS_DESC, 2.49, ralphsId, FROZEN_PEAS_URL);
        Item frozenPeas2 = new Item(FROZEN_PEAS, FROZEN_PEAS_DESC, 2.49, sfId, FROZEN_PEAS_URL);
        Item frozenPeas3 = new Item(FROZEN_PEAS, FROZEN_PEAS_DESC, 2.49, slomId, FROZEN_PEAS_URL);
        Item frozenPeas4 = new Item(FROZEN_PEAS, FROZEN_PEAS_DESC, 2.49, f4lId, FROZEN_PEAS_URL);
        Item frozenPeas5 = new Item(FROZEN_PEAS, FROZEN_PEAS_DESC, 2.49, tjsId, FROZEN_PEAS_URL);
        Item frozenPeas6 = new Item(FROZEN_PEAS, FROZEN_PEAS_DESC, 2.49, wfId, FROZEN_PEAS_URL);
        addItem(frozenPeas);
        addItem(frozenPeas1);
        addItem(frozenPeas2);
        addItem(frozenPeas3);
        ...
        addItem(frozenPeas5);
        addItem(frozenPeas6);
        final String FROZEN_CORN = "Frozen Corn";
        final String FROZEN_CORN_URL = "https://i.imgur.com/ZHecdk0.jpg";
        final String FROZEN_CORN_DESC = "Farm fresh, frozen corn kernels";
        Item frozenCorn = new Item(FROZEN_CORN, FROZEN_CORN_DESC, 2.49, vonsId, FROZEN_CORN_URL);
        Item frozenCorn1 = new Item(FROZEN_CORN, FROZEN_CORN_DESC, 2.49, ralphsId, FROZEN_CORN_URL);
        Item frozenCorn2 = new Item(FROZEN_CORN, FROZEN_CORN_DESC, 2.49, sfId, FROZEN_CORN_URL);
        Item frozenCorn3 = new Item(FROZEN_CORN, FROZEN_CORN_DESC, 2.49, slomId, FROZEN_CORN_URL);
        Item frozenCorn4 = new Item(FROZEN_CORN, FROZEN_CORN_DESC, 2.49, f4lId, FROZEN_CORN_URL);
        Item frozenCorn5 = new Item(FROZEN_CORN, FROZEN_CORN_DESC, 2.49, tjsId, FROZEN_CORN_URL);
        Item frozenCorn6 = new Item(FROZEN_CORN, FROZEN_CORN_DESC, 2.49, wfId, FROZEN_CORN_URL);
        addItem(frozenCorn);
        addItem(frozenCorn1);
        addItem(frozenCorn2);
        addItem(frozenCorn3);
        ...
        addItem(frozenCorn5);
        addItem(frozenCorn6);
        final String FROZEN_PC = "Frozen Peas and Corn";
        final String FROZEN_PC_URL = "https://i.imgur.com/9Jv6qxT.jpg";
        final String FROZEN_PC_DESC = "Farm fresh, frozen peas and carrots";
        Item frozenPAndC = new Item(FROZEN_PC, FROZEN_PC_DESC, 2.19, vonsId, FROZEN_PC_URL);
        Item frozenPAndC1 = new Item(FROZEN_PC, FROZEN_PC_DESC, 2.19, ralphsId, FROZEN_PC_URL);
        Item frozenPAndC2 = new Item(FROZEN_PC, FROZEN_PC_DESC, 2.19, sfId, FROZEN_PC_URL);
        Item frozenPAndC3 = new Item(FROZEN_PC, FROZEN_PC_DESC, 2.19, slomId, FROZEN_PC_URL);
        Item frozenPAndC4 = new Item(FROZEN_PC, FROZEN_PC_DESC, 2.19, f4lId, FROZEN_PC_URL);
        Item frozenPAndC5 = new Item(FROZEN_PC, FROZEN_PC_DESC, 2.19, tjsId, FROZEN_PC_URL);
        Item frozenPAndC6 = new Item(FROZEN_PC, FROZEN_PC_DESC, 2.19, wfId, FROZEN_PC_URL);
        addItem(frozenPAndC);
        addItem(frozenPAndC1);
        addItem(frozenPAndC2);
        addItem(frozenPAndC3);
        addItem(frozenPAndC4);
        addItem(frozenPAndC5);
        addItem(frozenPAndC6);
        final String FROZEN_BABY_CARROTS = "Frozen Baby Carrots";
        final String FROZEN_BABY_CARROTS_URL = "https://i.imgur.com/thdumVZ.jpg";
        final String FROZEN_BABY_CARROTS_DESC = "Farm fresh, frozen baby carrots";
        Item frozenBabyCarrots = new Item(FROZEN_BABY_CARROTS, FROZEN_BABY_CARROTS_DESC, 2.39, vonsId, FROZEN_BABY_CARROTS_URL);
        Item frozenBabyCarrots1 = new Item(FROZEN_BABY_CARROTS, FROZEN_BABY_CARROTS_DESC, 2.39, ralphsId, FROZEN_BABY_CARROTS_URL);
        Item frozenBabyCarrots2 = new Item(FROZEN_BABY_CARROTS, FROZEN_BABY_CARROTS_DESC, 2.39, sfId, FROZEN_BABY_CARROTS_URL);
        Item frozenBabyCarrots3 = new Item(FROZEN_BABY_CARROTS, FROZEN_BABY_CARROTS_DESC, 2.39, slomId, FROZEN_BABY_CARROTS_URL);
        Item frozenBabyCarrots4 = new Item(FROZEN_BABY_CARROTS, FROZEN_BABY_CARROTS_DESC, 2.39, f4lId, FROZEN_BABY_CARROTS_URL);
        Item frozenBabyCarrots5 = new Item(FROZEN_BABY_CARROTS, FROZEN_BABY_CARROTS_DESC, 2.39, tjsId, FROZEN_BABY_CARROTS_URL);
        Item frozenBabyCarrots6 = new Item(FROZEN_BABY_CARROTS, FROZEN_BABY_CARROTS_DESC, 2.39, wfId, FROZEN_BABY_CARROTS_URL);
        addItem(frozenBabyCarrots);
        addItem(frozenBabyCarrots1);
        addItem(frozenBabyCarrots2);
        addItem(frozenBabyCarrots3);
        addItem(frozenBabyCarrots4);
        addItem(frozenBabyCarrots5);
        addItem(frozenBabyCarrots6);
        final String FROZEN_MIXED_VEG = "Frozen Mixed Vegetables";
        final String FROZEN_MIXED_VEG_URL = "https://i.imgur.com/6famKNL.jpg";
        final String FROZEN_MIXED_VEG_DESC = "Farm fresh, frozen mix of different vegetables";
        Item frozenMixedVegetables = new Item(FROZEN_MIXED_VEG, FROZEN_MIXED_VEG_DESC, 2.69, vonsId, FROZEN_MIXED_VEG_URL);
        Item frozenMixedVegetables1 = new Item(FROZEN_MIXED_VEG, FROZEN_MIXED_VEG_DESC, 2.79, ralphsId, FROZEN_MIXED_VEG_URL);
        Item frozenMixedVegetables2 = new Item(FROZEN_MIXED_VEG, FROZEN_MIXED_VEG_DESC, 2.99, sfId, FROZEN_MIXED_VEG_URL);
        Item frozenMixedVegetables3 = new Item(FROZEN_MIXED_VEG, FROZEN_MIXED_VEG_DESC, 2.59, slomId, FROZEN_MIXED_VEG_URL);
        Item frozenMixedVegetables4 = new Item(FROZEN_MIXED_VEG, FROZEN_MIXED_VEG_DESC, 2.49, f4lId, FROZEN_MIXED_VEG_URL);
        Item frozenMixedVegetables5 = new Item(FROZEN_MIXED_VEG, FROZEN_MIXED_VEG_DESC, 2.39, tjsId, FROZEN_MIXED_VEG_URL);
        Item frozenMixedVegetables6 = new Item(FROZEN_MIXED_VEG, FROZEN_MIXED_VEG_DESC, 2.29, wfId, FROZEN_MIXED_VEG_URL);
        addItem(frozenMixedVegetables);
        addItem(frozenMixedVegetables1);
        addItem(frozenMixedVegetables2);
        addItem(frozenMixedVegetables3);
        addItem(frozenMixedVegetables4);
        addItem(frozenMixedVegetables5);
        addItem(frozenMixedVegetables6);
        final String FROZEN_BROCCOLI = "Frozen Broccoli";
        final String FROZEN_BROCCOLI_URL = "https://i.imgur.com/hRRX2dr.jpg";
        final String FROZEN_BROCCOLI_DESC = "Farm fresh, frozen and delicious broccoli";
        Item frozenBroccoli = new Item(FROZEN_BROCCOLI, FROZEN_BROCCOLI_DESC, 2.11, vonsId, FROZEN_BROCCOLI_URL);
        Item frozenBroccoli1 = new Item(FROZEN_BROCCOLI, FROZEN_BROCCOLI_DESC, 2.11, ralphsId, FROZEN_BROCCOLI_URL);
        Item frozenBroccoli2 = new Item(FROZEN_BROCCOLI, FROZEN_BROCCOLI_DESC, 2.11, sfId, FROZEN_BROCCOLI_URL);
        Item frozenBroccoli3 = new Item(FROZEN_BROCCOLI, FROZEN_BROCCOLI_DESC, 2.11, slomId, FROZEN_BROCCOLI_URL);
        Item frozenBroccoli4 = new Item(FROZEN_BROCCOLI, FROZEN_BROCCOLI_DESC, 2.11, f4lId, FROZEN_BROCCOLI_URL);
        Item frozenBroccoli5 = new Item(FROZEN_BROCCOLI, FROZEN_BROCCOLI_DESC, 2.11, tjsId, FROZEN_BROCCOLI_URL);
        Item frozenBroccoli6 = new Item(FROZEN_BROCCOLI, FROZEN_BROCCOLI_DESC, 2.11, wfId, FROZEN_BROCCOLI_URL);
        addItem(frozenBroccoli);
        addItem(frozenBroccoli1);
        addItem(frozenBroccoli2);
        addItem(frozenBroccoli3);
        addItem(frozenBroccoli4);
        addItem(frozenBroccoli5);
        addItem(frozenBroccoli6);
        final String FROZEN_CAULIFLOWER = "Frozen Cauliflower";
        final String FROZEN_CAULIFLOWER_URL = "https://i.imgur.com/LT2RO34.jpg";
        final String FROZEN_CAULIFLOWER_DESC = "Farm fresh, frozen and tasty cauliflower";
        Item frozenCauliflower = new Item(FROZEN_CAULIFLOWER, FROZEN_CAULIFLOWER_DESC, 1.99, vonsId, FROZEN_CAULIFLOWER_URL);
        Item frozenCauliflower1 = new Item(FROZEN_CAULIFLOWER, FROZEN_CAULIFLOWER_DESC, 1.99, ralphsId, FROZEN_CAULIFLOWER_URL);
        Item frozenCauliflower2 = new Item(FROZEN_CAULIFLOWER, FROZEN_CAULIFLOWER_DESC, 1.99, sfId, FROZEN_CAULIFLOWER_URL);
        Item frozenCauliflower3 = new Item(FROZEN_CAULIFLOWER, FROZEN_CAULIFLOWER_DESC, 1.99, slomId, FROZEN_CAULIFLOWER_URL);
        Item frozenCauliflower4 = new Item(FROZEN_CAULIFLOWER, FROZEN_CAULIFLOWER_DESC, 1.99, f4lId, FROZEN_CAULIFLOWER_URL);
        Item frozenCauliflower5 = new Item(FROZEN_CAULIFLOWER, FROZEN_CAULIFLOWER_DESC, 1.99, tjsId, FROZEN_CAULIFLOWER_URL);
        Item frozenCauliflower6 = new Item(FROZEN_CAULIFLOWER, FROZEN_CAULIFLOWER_DESC, 1.99, wfId, FROZEN_CAULIFLOWER_URL);
        addItem(frozenCauliflower);
        addItem(frozenCauliflower1);
        addItem(frozenCauliflower2);
        addItem(frozenCauliflower3);
        addItem(frozenCauliflower4);
        addItem(frozenCauliflower5);
        addItem(frozenCauliflower6);
        final String FROZEN_BLUEBERRIES = "Frozen Blueberries";
        final String FROZEN_BLUEBERRIES_URL = "https://i.imgur.com/TuxXXFN.jpg";
        final String FROZEN_BLUEBERRIES_DESC = "Blueberries fresh off the farm";
        Item frozenBlueberries = new Item(FROZEN_BLUEBERRIES, FROZEN_BLUEBERRIES_DESC, 2.49, vonsId, FROZEN_BLUEBERRIES_URL);
        Item frozenBlueberries1 = new Item(FROZEN_BLUEBERRIES, FROZEN_BLUEBERRIES_DESC, 2.49, ralphsId, FROZEN_BLUEBERRIES_URL);
        Item frozenBlueberries2 = new Item(FROZEN_BLUEBERRIES, FROZEN_BLUEBERRIES_DESC, 2.49, sfId, FROZEN_BLUEBERRIES_URL);
        Item frozenBlueberries3 = new Item(FROZEN_BLUEBERRIES, FROZEN_BLUEBERRIES_DESC, 2.49, slomId, FROZEN_BLUEBERRIES_URL);
        Item frozenBlueberries4 = new Item(FROZEN_BLUEBERRIES, FROZEN_BLUEBERRIES_DESC, 2.49, f4lId, FROZEN_BLUEBERRIES_URL);
        Item frozenBlueberries5 = new Item(FROZEN_BLUEBERRIES, FROZEN_BLUEBERRIES_DESC, 2.49, tjsId, FROZEN_BLUEBERRIES_URL);
        Item frozenBlueberries6 = new Item(FROZEN_BLUEBERRIES, FROZEN_BLUEBERRIES_DESC, 2.49, wfId, FROZEN_BLUEBERRIES_URL);
        addItem(frozenBlueberries);
        addItem(frozenBlueberries1);
        addItem(frozenBlueberries2);
        addItem(frozenBlueberries3);
        addItem(frozenBlueberries4);
        addItem(frozenBlueberries5);
        addItem(frozenBlueberries6);
        final String FROZEN_CHERRIES = "Dark Sweet Cherries";
        final String FROZEN_CHERRIES_URL = "https://i.imgur.com/aWWWYYs.jpg";
        final String FROZEN_CHERRIES_DESC = "Delicious and fresh, frozen cherries";
        Item frozenCherries = new Item(FROZEN_CHERRIES, FROZEN_CHERRIES_DESC, 3.39, vonsId, FROZEN_CHERRIES_URL);
        Item frozenCherries1 = new Item(FROZEN_CHERRIES, FROZEN_CHERRIES_DESC, 3.39, ralphsId, FROZEN_CHERRIES_URL);
        Item frozenCherries2 = new Item(FROZEN_CHERRIES, FROZEN_CHERRIES_DESC, 3.39, sfId, FROZEN_CHERRIES_URL);
        Item frozenCherries3 = new Item(FROZEN_CHERRIES, FROZEN_CHERRIES_DESC, 3.39, slomId, FROZEN_CHERRIES_URL);
        Item frozenCherries4 = new Item(FROZEN_CHERRIES, FROZEN_CHERRIES_DESC, 3.39, f4lId, FROZEN_CHERRIES_URL);
        Item frozenCherries5 = new Item(FROZEN_CHERRIES, FROZEN_CHERRIES_DESC, 3.39, tjsId, FROZEN_CHERRIES_URL);
        Item frozenCherries6 = new Item(FROZEN_CHERRIES, FROZEN_CHERRIES_DESC, 3.39, wfId, FROZEN_CHERRIES_URL);
        addItem(frozenCherries);
        addItem(frozenCherries1);
        addItem(frozenCherries2);
        addItem(frozenCherries3);
        addItem(frozenCherries4);
        addItem(frozenCherries5);
        addItem(frozenCherries6);
        final String FROZEN_STRAWBERRIES = "Whole Strawberries";
        final String FROZEN_STRAWBERRIES_URL = "https://i.imgur.com/2rcRsET.jpg";
        final String FROZEN_STRAWBERRIES_DESC = "Delicious frozen strawberries";
        Item frozenStrawberries = new Item(FROZEN_STRAWBERRIES, FROZEN_STRAWBERRIES_DESC, 3.99, vonsId, FROZEN_STRAWBERRIES_URL);
        Item frozenStrawberries1 = new Item(FROZEN_STRAWBERRIES, FROZEN_STRAWBERRIES_DESC, 3.99, ralphsId, FROZEN_STRAWBERRIES_URL);
        Item frozenStrawberries2 = new Item(FROZEN_STRAWBERRIES, FROZEN_STRAWBERRIES_DESC, 3.99, sfId, FROZEN_STRAWBERRIES_URL);
        Item frozenStrawberries3 = new Item(FROZEN_STRAWBERRIES, FROZEN_STRAWBERRIES_DESC, 3.99, slomId, FROZEN_STRAWBERRIES_URL);
        Item frozenStrawberries4 = new Item(FROZEN_STRAWBERRIES, FROZEN_STRAWBERRIES_DESC, 3.99, f4lId, FROZEN_STRAWBERRIES_URL);
        Item frozenStrawberries5 = new Item(FROZEN_STRAWBERRIES, FROZEN_STRAWBERRIES_DESC, 3.99, tjsId, FROZEN_STRAWBERRIES_URL);
        Item frozenStrawberries6 = new Item(FROZEN_STRAWBERRIES, FROZEN_STRAWBERRIES_DESC, 3.99, wfId, FROZEN_STRAWBERRIES_URL);
        addItem(frozenStrawberries);
        addItem(frozenStrawberries1);
        addItem(frozenStrawberries2);
        addItem(frozenStrawberries3);
        addItem(frozenStrawberries4);
        addItem(frozenStrawberries5);
        addItem(frozenStrawberries6);
        final String FROZEN_MIXED_BERRIES = "Mixed Berries";
        final String FROZEN_MIXED_BERRIES_URL = "https://i.imgur.com/8ONwiJX.jpg";
        final String FROZEN_MIXED_BERRIES_DESC = "Delicious mix of frozen berries";
        Item frozenMixedBerries = new Item(FROZEN_MIXED_BERRIES, FROZEN_MIXED_BERRIES_DESC, 3.09, vonsId, FROZEN_MIXED_BERRIES_URL);
        Item frozenMixedBerries1 = new Item(FROZEN_MIXED_BERRIES, FROZEN_MIXED_BERRIES_DESC, 3.09, ralphsId, FROZEN_MIXED_BERRIES_URL);
        Item frozenMixedBerries2 = new Item(FROZEN_MIXED_BERRIES, FROZEN_MIXED_BERRIES_DESC, 3.09, sfId, FROZEN_MIXED_BERRIES_URL);
        Item frozenMixedBerries3 = new Item(FROZEN_MIXED_BERRIES, FROZEN_MIXED_BERRIES_DESC, 3.09, slomId, FROZEN_MIXED_BERRIES_URL);
        Item frozenMixedBerries4 = new Item(FROZEN_MIXED_BERRIES, FROZEN_MIXED_BERRIES_DESC, 3.09, f4lId, FROZEN_MIXED_BERRIES_URL);
        Item frozenMixedBerries5 = new Item(FROZEN_MIXED_BERRIES, FROZEN_MIXED_BERRIES_DESC, 3.09, tjsId, FROZEN_MIXED_BERRIES_URL);
        Item frozenMixedBerries6 = new Item(FROZEN_MIXED_BERRIES, FROZEN_MIXED_BERRIES_DESC, 3.09, wfId, FROZEN_MIXED_BERRIES_URL);
        addItem(frozenMixedBerries);
        addItem(frozenMixedBerries1);
        addItem(frozenMixedBerries2);
        addItem(frozenMixedBerries3);
        addItem(frozenMixedBerries4);
        addItem(frozenMixedBerries5);
        addItem(frozenMixedBerries6);
        final String FROZEN_CRANBERRIES = "Whole Cranberries";
        final String FROZEN_CRANBERRIES_URL = "https://i.imgur.com/kjBHJw2.jpg";
        final String FROZEN_CRANBERRIES_DESC = "Fresh and delicious, frozen whole cranberries";
        Item frozenCranberries = new Item(FROZEN_CRANBERRIES, FROZEN_CRANBERRIES_DESC, 3.29, vonsId, FROZEN_CRANBERRIES_URL);
        Item frozenCranberries1 = new Item(FROZEN_CRANBERRIES, FROZEN_CRANBERRIES_DESC, 3.29, ralphsId, FROZEN_CRANBERRIES_URL);
        Item frozenCranberries2 = new Item(FROZEN_CRANBERRIES, FROZEN_CRANBERRIES_DESC, 3.29, sfId, FROZEN_CRANBERRIES_URL);
        Item frozenCranberries3 = new Item(FROZEN_CRANBERRIES, FROZEN_CRANBERRIES_DESC, 3.29, slomId, FROZEN_CRANBERRIES_URL);
        Item frozenCranberries4 = new Item(FROZEN_CRANBERRIES, FROZEN_CRANBERRIES_DESC, 3.29, f4lId, FROZEN_CRANBERRIES_URL);
        Item frozenCranberries5 = new Item(FROZEN_CRANBERRIES, FROZEN_CRANBERRIES_DESC, 3.29, tjsId, FROZEN_CRANBERRIES_URL);
        Item frozenCranberries6 = new Item(FROZEN_CRANBERRIES, FROZEN_CRANBERRIES_DESC, 3.29, wfId, FROZEN_CRANBERRIES_URL);
        addItem(frozenCranberries);
        addItem(frozenCranberries1);
        addItem(frozenCranberries2);
        addItem(frozenCranberries3);
        addItem(frozenCranberries4);
        addItem(frozenCranberries5);
        addItem(frozenCranberries6);
        final String FROZEN_BLACKBERRIES = "Frozen Fresh Blackberries";
        final String FROZEN_BLACKBERRIES_URL = "https://i.imgur.com/gT1TrQn.jpg";
        final String FROZEN_BLACKBERRIES_DESC = "Delicious, and fresh blackberries";
        Item frozenBlackberries = new Item(FROZEN_BLACKBERRIES, FROZEN_BLACKBERRIES_DESC, 2.99, vonsId, FROZEN_BLACKBERRIES_URL);
        Item frozenBlackberries1 = new Item(FROZEN_BLACKBERRIES, FROZEN_BLACKBERRIES_DESC, 2.99, ralphsId, FROZEN_BLACKBERRIES_URL);
        Item frozenBlackberries2 = new Item(FROZEN_BLACKBERRIES, FROZEN_BLACKBERRIES_DESC, 2.99, sfId, FROZEN_BLACKBERRIES_URL);
        Item frozenBlackberries3 = new Item(FROZEN_BLACKBERRIES, FROZEN_BLACKBERRIES_DESC, 2.99, slomId, FROZEN_BLACKBERRIES_URL);
        Item frozenBlackberries4 = new Item(FROZEN_BLACKBERRIES, FROZEN_BLACKBERRIES_DESC, 2.99, f4lId, FROZEN_BLACKBERRIES_URL);
        Item frozenBlackberries5 = new Item(FROZEN_BLACKBERRIES, FROZEN_BLACKBERRIES_DESC, 2.99, tjsId, FROZEN_BLACKBERRIES_URL);
        Item frozenBlackberries6 = new Item(FROZEN_BLACKBERRIES, FROZEN_BLACKBERRIES_DESC, 2.99, wfId, FROZEN_BLACKBERRIES_URL);
        addItem(frozenBlackberries);
        addItem(frozenBlackberries1);
        addItem(frozenBlackberries2);
        addItem(frozenBlackberries3);
        addItem(frozenBlackberries4);
        addItem(frozenBlackberries5);
        addItem(frozenBlackberries6);
        final String FROZEN_MANGO = "Mango Chunks";
        final String FROZEN_MANGO_URL = "https://i.imgur.com/nCEooon.jpg";
        final String FROZEN_MANGO_DESC = "Delicious and sweet, frozen mango chunks";
        Item frozenMango = new Item(FROZEN_MANGO, FROZEN_MANGO_DESC, 2.29, vonsId, FROZEN_MANGO_URL);
        Item frozenMango1 = new Item(FROZEN_MANGO, FROZEN_MANGO_DESC, 2.29, ralphsId, FROZEN_MANGO_URL);
        Item frozenMango2 = new Item(FROZEN_MANGO, FROZEN_MANGO_DESC, 2.29, sfId, FROZEN_MANGO_URL);
        Item frozenMango3 = new Item(FROZEN_MANGO, FROZEN_MANGO_DESC, 2.29, slomId, FROZEN_MANGO_URL);
        Item frozenMango4 = new Item(FROZEN_MANGO, FROZEN_MANGO_DESC, 2.29, f4lId, FROZEN_MANGO_URL);
        Item frozenMango5 = new Item(FROZEN_MANGO, FROZEN_MANGO_DESC, 2.29, tjsId, FROZEN_MANGO_URL);
        Item frozenMango6 = new Item(FROZEN_MANGO, FROZEN_MANGO_DESC, 2.29, wfId, FROZEN_MANGO_URL);
        addItem(frozenMango);
        addItem(frozenMango1);
        addItem(frozenMango2);
        addItem(frozenMango3);
        addItem(frozenMango4);
        addItem(frozenMango5);
        addItem(frozenMango6);
